...
template <> string_map &expected<sal::crypto::sha_1> = sha_1;
...
template <> string_map &expected<sal::crypto::sha_256> = sha_256;
...
template <> string_map &expected<sal::crypto::sha_384> = sha_384;
...
template <> string_map &expected<sal::crypto::sha_512> = sha_512;
