 ...
 *
 * Thread-safety: sinks can be shared between multiple loggers and/or workers
...
public:
  ...
  /**
   * Invoke virtual event_init() to initialise logger \a event message. This
   * method is called immediately after logger has created \a event. New
