...
// Specialisation for queue<mpmc>. Do not include directly
...
template <>
struct queue_hook<concurrent_usage::mpmc>
{
  volatile void *next;
};


template <typename T, queue_hook<concurrent_usage::mpmc> T::*Hook>
class queue<concurrent_usage::mpmc, T, Hook>
{
public:
